...
// version 1.0
// 2005-05-11 (last updated 2005-09-09)
...
// WHAT IT DOES:
// 
// More info at http://blog.monstuff.com/archives/cat_greasemonkey.html
// --------------------------------------------------------------------
//
// ==UserScript==
...
if (unsafeWindow) {
    alert("A newer version of this script is available at http://blog.monstuff.com");
}


/*============================================================================*/
if (!GM_setValue) { 
    var GM_setValue = function(key, value) { return; } 
}
if (!GM_getValue) {
    var GM_getValue = function(key, defaultValue) { return defaultValue; };
}
if (!GM_registerMenuCommand) {
    var GM_registerMenuCommand = function(a, b) { return; }
}

var deerPark = unsafeWindow;
...
var startTracing = function (onnew) {
    ...
    var NewXHR = function() {
        ...
        // onopen, onsend, onsetrequestheader, ononreadystatechange, ...
        this.requestHeaders = "";
        this.requestBody = "";
...
var Console = function() {
    ...
    this.traceXHR = function(xhr) {
        ...
        xhr.ononreadystatechange = xhrNode.update;
...
"</dl>" +
"<h1>About</h1>" +
"<p>'XMLHttpRequest Debugging' user script. Version 1.0</p>" +
