...
Without going deep into a full analysis, 
...
As Bohm-Bawerk pointed out Marx normalizes different kinds of labor by using an unspecified multiplier which determines the value of skilled labor relative to unskilled labor. This is not the first time that fudge factors are used to wave away something that is absolutely obvious. But more fundamentally, it introduces circular reasoning.
